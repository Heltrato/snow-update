...
public abstract class Region {
    ...
    public static final ResourceKey<Biome> DEFERRED_PLACEHOLDER = ResourceKey.create(Registries.BIOME, new ResourceLocation(SnowUpdate.MOD_ID, "deferred_placeholder"));
     ...
     */
    protected final void addModifiedVanillaOverworldBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper, Consumer<ModifiedOverworldBuilder> onModify)
    {
        ModifiedOverworldBuilder builder = new ModifiedOverworldBuilder();
